...
def conditionSelection(runningAllocation, condition_names, nPeoplePerCond, sex, age, participantId):
    ...
    # Goal to have overall balanced amount of people in the conditions 
    # this so as not to end up with 2 people in one condition and 30 in another, could be a problem if we stop data acquisition early
